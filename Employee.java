...
public class Employee {
    ...
    static class Hod extends Employee {
        Hod(String name, String id, String address, String mail, long mobile, double bp) {
            super(name, id, address, mail, mobile, bp);
            calculateSalary(150, 50, 18, 15);
            }
     }
    ...
    public static void main(String[] args) {
        ...
        switch (choice) {
            ...
            case 4:
                ...
                break;
            case 5:
                emp = new Hod(name, id, address, mail, mobile, bp);
                break;
            default:
